error id: file://<WORKSPACE>/trending-movies-service/src/main/java/com/trendingmoviesservice/resources/TrendingRecources.java:_empty_/Rating#
...
public class TrendingRecources extends TrendingServiceGrpc.TrendingServiceImplBase {
    ...
    public List<Movie> getTrendingMovies() {
        ...
        for (int i = 0; i < trendingRatings.size(); i++) {
            ...
            String currentMovieId = trendingRatings.get(i).getMovieId();
